    ...
    mounted(){
     ...
     methods:{
         Play(){
            ...
            //           if(that.index==that.playIndex.length) {
            //             that.index=0
            //         }
                     
            //          var dataIndex = that.playIndex[index][0]
            //          var timeIndex =that.playIndex[index][1]
            //        that.dateIndex =  dataIndex 
            //    that.houerIndex =timeIndex
            //            var len =0;
            
            //     that.currentDate = that.timeList[dataIndex].date
