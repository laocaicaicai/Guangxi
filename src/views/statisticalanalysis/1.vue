  ...
  <div class="analysisFireProducts">
    ...
    <div class="titleBread">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        <el-breadcrumb-item style="color:rgb(153,153,153) !important">统计分析</el-breadcrumb-item>
        <el-breadcrumb-item>火点产品</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <!-- 内容区域
    -->
        ...
        series: [
          {
            ...
            data: [{ value: 254, name: "广西壮族自治区共计254个热点网格" }]
          },
          {
            name: "火点数量",
            type: "pie",
...
height: calc(100vh - 100px);
  ...
  .titleBread {
    height: 30px;
    line-height: 30px;
    border-left: 3px solid rgb(19, 111, 205);
    padding-left: 10px;
    margin-bottom: 30px;
